    ...
    return (
      <div className="z-100 scrollbar-hidden fixed top-0 right-0 flex flex-col items-end h-full justify-center">
        <motion.nav
          ...
          className="flex flex-col items-end backdrop-blur-xs justify-center shadow-lg rounded-l-[30px] bg-white/30 transition-colors duration-1000 shadow-[inset_0_-4px_10px_-1px_rgba(255,255,255,0.1)] h-full w-full">
