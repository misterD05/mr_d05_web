    ...
    return (
      <div className="z-100 scrollbar-hidden fixed top-0 right-0 flex flex-col items-end h-full justify-center">
            <motion.nav
              ...
              className=" m-5  flex flex-col items-end backdrop-blur-xs justify-center shadow-lg rounded-[30px] bg-[black]/5 w-fit h-fit transition-colors duration-1000 shadow-[inset_0_-4px_10px_-1px_rgba(255,255,255,0.1)]">
            <motion.a
            ...
            <motion.a
              className="group w-auto h-auto m-2 p-3 rounded-[20px] text-(--bgc) bg-(--magenta) text-lg text-center flex flex-row items-center justify-center gap-2"
              href="../aboutMe"
              whileHover={{backgroundColor: "rgba(var(--magenta), 0.3)", backdropFilter: "blur(8px)" }}
              whileTap={{ scale: 0.95, rotate: -10 }}
            ...
            <motion.a
              className="group w-auto h-auto m-2 p-3 rounded-[20px] text-(--bgc) bg-(--blue) text-lg text-center flex flex-row items-center justify-center gap-2"
              href="../myProjects"
              whileHover={{backgroundColor: "var(--blue)/30", backdropFilter: "blur(8px)"}}
              whileTap={{ scale: 0.95, rotate: -10 }}
            ...
            <motion.a
              className="group w-auto h-auto m-2 p-3 rounded-[20px] text-(--bgc) bg-(--acqua) text-lg text-center flex flex-row items-center justify-center gap-2"
              href="https://github.com/misterD05"
              whileHover={{backgroundColor: "var(--acqua)/30", backdropFilter: "blur(8px)"}}
              whileTap={{ scale: 0.95, rotate: -10 }}
            ...
            <motion.a
              className="group w-auto h-auto m-2 p-3 rounded-[20px] text-(--bgc) bg-(--tangerine) text-lg text-center flex flex-row items-center justify-center gap-2"
              href="../contacts"
              whileHover={{backgroundColor: "var(--tangerine)/30", backdropFilter: "blur(8px)"}}
              whileTap={{ scale: 0.95, rotate: -10 }}
            ...
            <motion.a
              className="group w-auto h-auto m-2 p-3 rounded-[20px] text-(--bgc) bg-(--mode) text-lg text-center flex flex-row items-center justify-center gap-2"
              onClick={() => {
                setDark(prev => {
                  const next = !prev;
              ...
              whileHover={{backgroundColor: "var(--mode)/30", backdropFilter: "blur(8px)"}}
              whileTap={{ scale: 0.95, rotate: -10 }}
